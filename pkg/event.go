...
// IsStat returns true if the event type is a ObjectAccessedHead request,
// which wants to stat an object
func (e *BucketEvent) IsStat() bool {
	return e.EventName == notification.ObjectAccessedHead
}
